...
class RegEx:
	def __init__(
		...
		filename: str = '',
		params: Dict[str, Any] = {},
		init_from_params_dict: bool = False):
	...
	def _initialize_from_params(self, params: Dict[str, Any]) -> None:
		'''Initializes the Regular Expression from specified parameters.

		Args:
			params: a dictionary containing the parameters to initialize the
				regular expression with. It must contain the keys 'alphabet'
				whose value is a list of characters, and 'regex_string' whose
				value is the regular expression string.
		'''
		self.regex_string = params['regex_string']
